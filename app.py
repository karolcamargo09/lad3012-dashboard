...
# ============================================================
TU_NOMBRE = "Karol Georgina Camargo Valencia"
TU_ID     = "180815"
...
with st.expander("🔍 Preguntas guia para encontrar tu insight"):
        st.markdown("Juega con los filtros del sidebar mientras te haces estas preguntas:")
        st.markdown("1. Region menos rentable: deja solo una region a la vez y revisa cual tiene el margen mas bajo.")
        st.markdown("2. Categoria problema: revisa si alguna categoria tiene margen bajo.")
        st.markdown("3. Patron temporal: observa si hay meses con ventas mas altas o mas bajas.")
        st.markdown("4. Reto extra: piensa que decision tomarias como gerente.")
